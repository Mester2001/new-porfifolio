...
export default function App() {
  ...
  return (
    <div className={`min-h-screen bg-[var(--color-bg-base)] text-[var(--color-text-primary)] selection:bg-[#ff4d24]/30 font-sans ${lang === 'ar' ? 'font-arabic' : ''}`}>
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 border-b ${scrolled ? 'glass py-3' : 'bg-transparent border-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-2 group cursor-pointer">
            <div className="w-10 h-10 bg-gradient-to-br from-[#ff4d24] to-[#ff7e5f] rounded-xl flex items-center justify-center shadow-lg shadow-[#ff4d24]/20 group-hover:scale-110 transition-transform">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[var(--color-text-secondary)]">
            {['Home', 'About', 'Skills', 'Experience', 'Projects', 'Contact'].map((item) => (
              <a key={item} href={`#${item.toLowerCase()}`} className="hover:opacity-100 hover:text-[#ff4d24] transition-all cursor-pointer">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              {theme === 'dark' ? <Sun size={18} className="text-yellow-400" /> : <Moon size={18} className="text-[#ff4d24]" />}
            </button>
            <button 
            ...
            <button 
              ...
              className="bg-[var(--color-text-primary)] text-[var(--color-bg-base)] px-6 py-2 rounded-full text-sm font-bold flex items-center gap-2 hover:bg-[#ff4d24] hover:text-white transition-all shadow-xl shadow-black/5"
            >
              <Sparkles size={16} />
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden pt-24 mesh-bg">
        {/* Animated Orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#ff4d24]/10 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#0b1a2a]/10 rounded-full blur-[120px] animate-pulse delay-700" />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-[var(--glass-bg)] border border-[var(--glass-border)] text-xs font-mono tracking-widest text-[#ff4d24] mb-8">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#ff4d24]/50 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#ff4d24]"></span>
              </span>
            ...
            <h1 className="text-4xl md:text-7xl lg:text-8xl font-bold tracking-tighter mb-8 leading-[0.9]">
              {lang === 'ar' ? (
                <>خالد محمد <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff4d24] to-[#ff7e5f]">مطور ويب متكامل</span></>
              ) : (
                <>Khalid Mohamed <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff4d24] to-[#ff7e5f]">Full Stack Dev</span></>
              )}
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <a href="#contact" className="px-8 py-4 bg-[#ff4d24] rounded-2xl font-bold text-lg hover:bg-[#ff4d24]/80 transition-all hover:scale-105 shadow-2xl shadow-[#ff4d24]/20">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tighter">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#ff4d24] to-[#ff7e5f]">
                {lang === 'ar' ? 'تعرف عليّ أكثر' : 'Get to know me more'}
              </span>
            </h2>
            <div className="h-1 w-20 bg-gradient-to-r from-[#ff4d24] to-[#ff7e5f] mx-auto rounded-full"></div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
                <div className="flex items-center gap-4 group">
                  <div className="w-12 h-12 rounded-2xl bg-[#ff4d24]/10 flex items-center justify-center text-[#ff4d24] border border-[#ff4d24]/20 group-hover:bg-[#ff4d24] group-hover:text-white transition-all">
                ...
                <div className="flex items-center gap-4 group">
                  <div className="w-12 h-12 rounded-2xl bg-[#ff7e5f]/10 flex items-center justify-center text-[#ff7e5f] border border-[#ff7e5f]/20 group-hover:bg-[#ff7e5f] group-hover:text-white transition-all">
                    <Zap size={24} />
                  </div>
                  <div>
                    <h4 className="font-bold text-[var(--color-text-primary)]">
              ...
              <a href="#contact" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-[#ff4d24] to-[#ff7e5f] rounded-2xl font-bold text-white hover:opacity-90 transition-all shadow-xl shadow-[#ff4d24]/20 gap-3">
            ...
            >
              <AboutFeatureCard 
                icon={<Code className="text-[#ff4d24]" />}
              ...
              />
              <AboutFeatureCard 
                icon={<Smartphone className="text-[#ff7e5f]" />}
                ...
                >
                  ...
                  <div className={`md:w-1/2 w-full ${index % 2 === 0 ? 'md:pr-16 md:text-right' : 'md:pl-16 md:text-left'} mb-8 md:mb-0`}>
                    <div className={`inline-block px-4 py-1 rounded-full text-xs font-bold mb-4 ${
                      exp.color === 'orange' ? 'bg-[#ff4d24]/10 text-[#ff4d24]' : 
                      exp.color === 'navy' ? 'bg-[#0b1a2a]/20 text-[#94a3b8]' : 
                      'bg-[#ff7e5f]/10 text-[#ff7e5f]'
                    }`}>
                      {exp.year}
                    </div>
                    <h3 className="text-2xl font-bold mb-2">{exp.title[lang]}</h3>
                    <p className={`font-medium mb-4 ${
                      exp.color === 'orange' ? 'text-[#ff4d24]' : 
                      exp.color === 'navy' ? 'text-[#94a3b8]' : 
                      'text-[#ff7e5f]'
                    }`}>{exp.company[lang]}</p>
                  ...
                  <div className={`absolute left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full border-4 border-[var(--color-bg-base)] z-10 hidden md:block ${
                    exp.color === 'orange' ? 'bg-[#ff4d24]' : 
                    exp.color === 'navy' ? 'bg-[#0b1a2a]' : 
                    'bg-[#ff7e5f]'
                  }`}></div>
      ...
      <section id="projects" className="py-32 bg-[var(--color-bg-base)]">
        <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
              <div>
                <h2 className="text-sm font-mono text-[#ff4d24] uppercase tracking-widest mb-4">Portfolio</h2>
                <div className="flex items-center gap-4">
                  ...
                  <button 
                    ...
                    className="p-3 bg-[#ff4d24]/10 text-[#ff4d24] border border-[#ff4d24]/20 rounded-xl hover:bg-[#ff4d24] hover:text-white transition-all shadow-lg shadow-[#ff4d24]/10"
            ...
            <AnimatePresence>
              {projects.filter(p => activeTab === 'all' || p.category === activeTab).map((project) => (
                <motion.div
                  ...
                  className="group relative bg-[var(--color-bg-card)] border border-white/10 rounded-3xl p-0 hover:border-[#ff4d24]/50 transition-all overflow-hidden shadow-2xl shadow-black/50"
                >
                  ...
                  <div className="p-8 relative z-10">
                    <div className="flex justify-between items-start mb-6">
                      <div className="p-3 bg-[var(--glass-bg)] rounded-2xl">
                        <Terminal className="text-[#ff4d24]" />
                      </div>
                  ...
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#ff4d24]/10 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity" />
                </motion.div>
              ))}
            </AnimatePresence>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-12">
              <h2 className="text-3xl font-bold flex items-center gap-4">
                <Award className="text-[#ff7e5f]" />
                {lang === 'ar' ? 'الشهادات' : 'Certifications'}
              </h2>
              <button 
                onClick={() => setIsCertModalOpen(true)}
                className="p-3 bg-[#ff7e5f]/10 text-[#ff7e5f] border border-[#ff7e5f]/20 rounded-xl hover:bg-[#ff7e5f] hover:text-white transition-all shadow-lg shadow-[#ff7e5f]/10"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {certifications.map((cert, index) => (
                <div key={index} className="flex flex-col p-6 bg-[var(--color-bg-card)] border border-[var(--glass-border)] rounded-2xl hover:border-[#ff7e5f]/30 transition-all group shadow-xl shadow-black/10">
                  <div className="w-full h-32 mb-6 bg-[#ff7e5f]/5 rounded-xl flex items-center justify-center text-[#ff7e5f] overflow-hidden border border-[var(--glass-border)]">
                    {cert.image ? (
                  ...
                  <div className="flex-1 space-y-2">
                    <h5 className="font-bold text-sm leading-tight group-hover:text-[#ff7e5f] transition-colors uppercase tracking-tight">{cert.title}</h5>
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-[var(--glass-border)]">
                      ...
                      <span className="text-[10px] font-mono text-[#ff7e5f]/60 font-bold">{cert.date}</span>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2 mb-6">
                <div className="w-8 h-8 bg-[#ff4d24] rounded-lg flex items-center justify-center">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-sm font-bold uppercase tracking-widest text-[#ff4d24] mb-6">
              ...
              <ul className="space-y-4">
                {['home', 'about', 'skills', 'experience', 'projects', 'contact'].map((item) => (
                  <li key={item}>
                    <a 
                      href={`#${item}`} 
                      className="text-[var(--color-text-secondary)] hover:text-[#ff4d24] transition-colors text-sm font-medium"
                    >
            ...
            <div>
              ...
              <ul className="space-y-4">
                <ContactInfoItem 
                  icon={<Mail size={18} className="text-[#ff4d24]" />} 
                  text="mhmh4729@gmail.com" 
                  href="mailto:mhmh4729@gmail.com"
                />
                <ContactInfoItem 
                  icon={<Phone size={18} className="text-[#ff4d24]" />} 
                  text="+249 119 740 859" 
                  href="tel:+249119740859"
                />
                <ContactInfoItem 
                  icon={<MapPin size={18} className="text-[#ff4d24]" />} 
                  text={lang === 'ar' ? 'الخرطوم، السودان' : 'Khartoum, Sudan'} 
                />
                <ContactInfoItem 
                  icon={<Linkedin size={18} className="text-[#ff4d24]" />} 
                  text="LinkedIn" 
            ...
            >
              <div className="p-8 border-b border-white/5 flex justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-[#ff4d24]/10 rounded-lg text-[#ff4d24]">
                    <Sparkles size={20} />
                  </div>
              ...
              <div className="p-8 h-[400px] overflow-auto space-y-6 scroll-smooth">
                ...
                {aiMessages.map((msg, idx) => (
                  <motion.div 
                    ...
                    className={`p-4 rounded-2xl text-sm leading-relaxed border max-w-[85%] ${
                      msg.role === 'user' 
                      ? 'bg-[#ff4d24] text-white ml-auto border-[#ff4d24] rounded-tr-none' 
                      : 'bg-[#ff4d24]/10 border-[#ff4d24]/20 text-[var(--color-text-primary)] rounded-tl-none'
                    }`}
                  >
                ...
                {isAiLoading && (
                  <div className="flex gap-2 p-4 bg-[#ff4d24]/5 rounded-2xl w-20 justify-center border border-[#ff4d24]/10">
                    <span className="w-1.5 h-1.5 bg-[#ff4d24] rounded-full animate-bounce" style={{ animationDelay: '0s' }} />
                    <span className="w-1.5 h-1.5 bg-[#ff4d24] rounded-full animate-bounce" style={{ animationDelay: '0.2s' }} />
                    <span className="w-1.5 h-1.5 bg-[#ff4d24] rounded-full animate-bounce" style={{ animationDelay: '0.4s' }} />
                  </div>
                )}
              </div>
              ...
              <div className="p-8 border-t border-[var(--glass-border)] flex gap-4">
                <input 
                  ...
                  className="flex-1 bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl px-6 py-4 focus:outline-none focus:border-[#ff4d24] transition-all font-medium"
                  onKeyDown={(e) => e.key === 'Enter' && handleAiAsk()}
                />
                <button 
                  onClick={handleAiAsk}
                  disabled={isAiLoading}
                  className="bg-[var(--color-text-primary)] text-[var(--color-bg-base)] px-8 rounded-xl font-bold hover:bg-[#ff4d24] hover:text-white transition-all flex items-center justify-center disabled:opacity-50"
                >
              ...
              <form onSubmit={handleAddProject} className="p-8 space-y-6 max-h-[70vh] overflow-auto">
                <div className="space-y-2">
                  ...
                  <div className="relative group cursor-pointer">
                    ...
                    />
                    <div className="w-full h-40 bg-[var(--glass-bg)] border-2 border-dashed border-[var(--glass-border)] rounded-2xl flex flex-col items-center justify-center group-hover:border-[#ff4d24]/50 transition-all overflow-hidden">
                      {newProject.image ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl px-4 py-3 focus:outline-none focus:border-[#ff4d24]"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      className="w-full bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl px-4 py-3 focus:outline-none focus:border-[#ff4d24] appearance-none"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl px-4 py-3 focus:outline-none focus:border-[#ff4d24] h-24"
                  />
                </div>
                ...
                <button 
                  type="submit"
                  className="w-full py-4 bg-[var(--color-text-primary)] text-[var(--color-bg-base)] font-bold rounded-xl hover:bg-[#ff4d24] hover:text-white transition-all shadow-xl shadow-black/10"
                >
...
function FooterSocialLink({ href, icon }: { href: string, icon: React.ReactNode }) {
  return (
    <a 
      ...
      target="_blank" 
      rel="noopener noreferrer"
      className="w-10 h-10 rounded-xl bg-[var(--glass-bg)] border border-[var(--glass-border)] flex items-center justify-center text-[var(--color-text-secondary)] hover:text-[#ff4d24] hover:border-[#ff4d24]/50 transition-all hover:-translate-y-1"
    >
      {icon}
    </a>
  );
...
function ContactInfoItem({ icon, text, href }: { icon: React.ReactNode, text: string, href?: string }) {
  const content = (
    <div className="flex items-center gap-3 group cursor-pointer">
      <div className="w-10 h-10 rounded-xl bg-[var(--glass-bg)] border border-[var(--glass-border)] flex items-center justify-center group-hover:border-[#ff4d24]/50 transition-all">
        {icon}
      </div>
...
function StatItem({ label, value }: { label: string, value: string }) {
  return (
    <div className="text-center group cursor-default">
      <div className="text-4xl md:text-5xl font-bold tracking-tighter mb-2 group-hover:text-[#ff4d24] transition-colors">{value}</div>
...
function SkillCard({ label, level }: { label: string, level: string }) {
  return (
    <div className="p-6 bg-[var(--color-bg-card)] border border-[var(--glass-border)] rounded-2xl group hover:border-[#ff4d24]/30 transition-all shadow-xl shadow-black/20">
      ...
      <div className="h-1 bg-[var(--glass-bg)] rounded-full overflow-hidden">
        <motion.div 
          ...
          className="h-full bg-gradient-to-r from-[#ff4d24] to-[#ff7e5f]"
        />
      </div>
    </div>
  );
...
function SocialLink({ href, icon, label }: { href: string, icon: React.ReactNode, label?: string }) {
  return (
    <a 
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="group relative w-16 h-16 bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-2xl flex items-center justify-center hover:bg-white/10 hover:border-[#ff4d24]/50 hover:text-[#ff4d24] transition-all hover:-translate-y-2"
    >
      {icon}
      {label && (
